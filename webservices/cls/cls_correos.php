...
class cls_correos{
	...
	function _build_header($content_type)
	{
		...
		$this->mail_header .= "Message-Id: <" . md5(uniqid(rand())) . ".__@" . $_SERVER['SERVER_ADDR'] . ">" . BR;
		$this->mail_header .= "MIME-Version: 1.0" . BR;
		$this->mail_header .= "X-Mailer: ". $this->get_version() . BR . BR;
	}
	...
	function _debug($msg, $element="")
	{
		if ($this->debug_status == "yes"){
			$this->error = $this->error_msg[$msg]."$element<br>";
		}
